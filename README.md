...
- 🍏 **Apple Silicon (M1 / M2 / M3 / M4)**: [`CursorPulse-v0.3.1-mac-arm64.dmg`](https://github.com/hieuduy1751/cursor-pulse/releases/download/v0.3.1/CursorPulse-v0.3.1-mac-arm64.dmg)
- 💻 **Intel (x86_64)**: [`CursorPulse-v0.3.1-mac-x64.dmg`](https://github.com/hieuduy1751/cursor-pulse/releases/download/v0.3.1/CursorPulse-v0.3.1-mac-x64.dmg)
- ⚡️ **Universal (Dual Arch)**: [`CursorPulse-v0.3.1-mac-universal.dmg`](https://github.com/hieuduy1751/cursor-pulse/releases/download/v0.3.1/CursorPulse-v0.3.1-mac-universal.dmg)
